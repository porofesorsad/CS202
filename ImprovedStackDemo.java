	...
	public static void main(String[] args) 
	{
		...
		do
		{
			...
			if(option == 1)
			{
				...
				{
					System.out.println("Not Enough room for one item");
				}
			...
			else if(option == 2)
			{
				...
				System.out.println("What's the second item you would like to push?");
				...
				{
					System.out.println("Not enough room for two items");
				}
			}
			...
			else if(option == 4)
			{
				...
				{
					System.out.println("There are less than two items in the stack");
				}
			}
